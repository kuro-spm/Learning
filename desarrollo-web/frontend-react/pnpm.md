...
Aparece en cualquier proyecto frontend en React o TypeScript, desde una tienda online hasta un panel de administración. Al clonar el repositorio, se ejecuta pnpm para instalar los paquetes necesarios (React, librerías de UI, herramientas de build, etc.) antes de arrancar la aplicación en local o en CI/CD.
