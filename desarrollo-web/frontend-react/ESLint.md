...
Aparece en cualquier proyecto frontend con JavaScript o TypeScript — una tienda online, un panel de administración, una app de gestión de tareas — normalmente configurado para ejecutarse:
