...
Aparece en cualquier proyecto React que testee componentes de UI con Jest o Vitest: una tienda online, un blog o una app de gestión de tareas. El framework de testing lo configura automáticamente cuando el entorno es `jsdom`, por lo que no se invoca directamente en el código de tests.
...
test("muestra el nombre del producto", () => {
  render(<ProductCard name="Zapatillas" />);
