...
Aparece en cualquier componente que tenga más de una variante visual: un botón que cambia de color según su estado (primario, deshabilitado, cargando), una tarjeta de producto que se resalta si está en oferta, o un elemento de lista que cambia de estilo si está seleccionado.
