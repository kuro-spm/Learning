...
Se usa en tests de componentes React para validar flujos de usuario reales: rellenar un formulario de registro, hacer clic en botones de acción de una tienda online, navegar entre campos con Tab, o interactuar con selects y checkboxes de un panel de administración. Se usa junto a `@testing-library/react` y `vitest` como entorno de test.
