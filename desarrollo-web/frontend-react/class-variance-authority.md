...
Aparece en la capa de componentes reutilizables de una aplicación React: botones, badges, alertas o tarjetas de producto que necesitan varias combinaciones de estilo (color según el estado, tamaño, énfasis). Se suele encontrar en una carpeta como `src/components/ui/`, junto con Tailwind CSS como motor de clases.
