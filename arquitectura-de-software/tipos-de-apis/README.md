...
> ¿Te interesa cómo se construye el backend que sirve estas APIs? Echa un vistazo a la guía de [Clean Architecture](../clean-architecture/README.md) y a la de [transición de WPF a web](../../desarrollo-web/de-wpf-a-web/README.md) si vienes de escritorio.
