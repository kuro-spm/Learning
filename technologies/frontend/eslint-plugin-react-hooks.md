...
En **EcoWaveProjectManagement**, este plugin está configurado como parte de ESLint en el frontend React. Se ejecuta automáticamente durante el desarrollo (en el editor) y en el pipeline de CI, impidiendo que código con Hooks mal usados llegue a `main`.
...
**Configuración en el proyecto:** las reglas están activadas como `error` (no como `warn`), lo que bloquea la compilación si se incumplen.
