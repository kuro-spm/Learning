...
En **EcoWaveProjectManagement**, Vitest se usa en la capa frontend (React) para testear:

- Lógica de transformación de datos antes de enviarlos al backend C#/.NET.
...
*En resumen: Vitest es el xUnit del frontend Vite — misma filosofía de tests unitarios que ya conoces, pero adaptada al ecosistema JavaScript del proyecto.*
