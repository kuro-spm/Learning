...
En **EcoWaveProjectManagement**, el frontend React consume una API REST construida en C#/.NET. TanStack Query actúa como la capa que:

- Llama a los endpoints del backend (proyectos, tareas, usuarios, métricas de impacto).
