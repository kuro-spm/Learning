...
En **EcoWaveProjectManagement**, el plugin se registra en el archivo de configuración de Vite y actúa de forma transparente durante el desarrollo y el build de producción del frontend React. No requiere intervención directa una vez configurado.
