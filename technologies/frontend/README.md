# Frontend — Guía de tecnologías

Documentación introductoria del stack frontend de **EcoWaveProjectManagement**, escrita para desarrolladoras con experiencia en backend (C#/.NET) que se acercan al frontend por primera vez.

Cada archivo explica qué es la tecnología, por qué existe, cómo encaja en este proyecto y lo mínimo que necesitas saber para no perderte.
...
| 12 | [shadcn/ui](shadcn-ui.md) | La biblioteca de componentes del proyecto. La usarás constantemente. |
...
Componentes y utilidades propios de la organización Macción.

| # | Archivo | Por qué leerlo aquí |
|---|---|---|
| 19 | [@maccion/manager-ui](maccion-manager-ui.md) | UI para las vistas de gestión (escritorio). |
| 20 | [@maccion/operativa-ui](maccion-operativa-ui.md) | UI para las vistas de planta (táctil). |
...
| # | Archivo | Por qué leerlo aquí |
|---|---|---|
| 21 | [ESLint](ESLint.md) | El linter general. Leer antes que los plugins. |
| 22 | [@eslint/js](eslint-js.md) | Configuración base de ESLint para JavaScript. |
| 23 | [typescript-eslint](typescript-eslint.md) | Añade reglas específicas de TypeScript al linter. |
| 24 | [eslint-plugin-react-hooks](eslint-plugin-react-hooks.md) | Valida el uso correcto de los Hooks de React. |
| 25 | [eslint-plugin-react-refresh](eslint-plugin-react-refresh.md) | Garantiza que el hot reload funcione correctamente en desarrollo. |
...
| # | Archivo | Por qué leerlo aquí |
|---|---|---|
| 26 | [Vitest](Vitest.md) | El framework de tests. Equivale a xUnit en .NET. Leer primero. |
| 27 | [jsdom](jsdom.md) | Simula el navegador durante los tests. Necesario para entender el entorno. |
| 28 | [@testing-library/react](testing-library-react.md) | Cómo se renderizan y testean componentes React. |
| 29 | [@testing-library/jest-dom](testing-library-jest-dom.md) | Matchers adicionales para hacer assertions sobre el DOM. |
| 30 | [@testing-library/user-event](testing-library-user-event.md) | Simula clics, escritura y otras interacciones reales del usuario. |
...
**Librerías Internas**
- [@maccion/manager-ui](maccion-manager-ui.md)
- [@maccion/operativa-ui](maccion-operativa-ui.md)
