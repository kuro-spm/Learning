...
En **EcoWaveProjectManagement**, `tailwind-merge` se usa en los componentes React del frontend para construir clases CSS dinámicas de forma segura. Aparece habitualmente en:
