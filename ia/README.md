...
Cómo trabajar con modelos de lenguaje (LLMs) desde el punto de vista de quien programa: qué información deben recibir, cómo gestionarla cuando crece, cómo integrarlos en una aplicación que aguante producción y cómo usarlos para escribir código sin perder el control de lo que entra en el repositorio.
